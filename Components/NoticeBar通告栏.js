  ...
  render() {
    ...
    return (
      <View style={{ marginTop: 10 }}>
        ...
        <NoticeBar style={{marginTop:20}} mode="closable" onClick={() => alert('will close')}>
          Notice: Yu 'E Bao will be delayed during.
        </NoticeBar>
      </View>
    );
  }
...
AppRegistry.registerComponent('Ant', () => NoticeBarExample);